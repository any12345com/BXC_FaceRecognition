...
namespace BXC_Algorithm {
    ...
    public:
        void encode(unsigned char * in_data, int size, std::string& out_encoded) {
        ...
        void decode(const std::string& in_data, std::string& out_decoded) {
            int in_len = in_data.size();
            int i = 0;
            int j = 0;
            int in_ = 0;
        ...
        std::string decode(const std::string& in_data) {
